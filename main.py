...
def message_probability(user_message, recognised_words, single_response=False, required_words=[]):
    ...
    #Counts how many messages are present in each predifined message
...
def check_all_messages(message):
    ...
    response('Thank you!', ['anytime', 'welcome'], required_words=['anytime', 'welcome'])

    response(long_responses.R_DUMB, ['I', 'am', 'respond'], required_words=['am', 'respond'])
